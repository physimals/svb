...
def test(model):
    ...
    vae_no_post_corr = VaeNormalFit(model,mode_corr='no_post_corr', learning_rate=LEARNING_RATE, batch_size=BATCH_SIZE, draw_size=DRAW_SIZE)
    ...
    vae_post_corr = VaeNormalFit(model,mode_corr='infer_post_corr', learning_rate=LEARNING_RATE, batch_size=BATCH_SIZE, draw_size=DRAW_SIZE)
